...
<div class="container-fluid animated fadeIn">
    <div class="col-xs-12 my-content">
        <div class="page-header">
            <h2>
                <i class="icon-table2 s24"></i>&nbsp;资源管理
            </h2>
        </div>
        <table cellpadding="0" cellspacing="0" class="table my-hover table-bordered"
            ...
            <thead>
            <tr>
                <th class="thead-val" width="20%"><b class="s15">资源名称</b></th>
                <th class="thead-val" width="15%"><b class="s15">资源类别</b></th>
                <th class="thead-val" width="15%"><b class="s15">操作类别</b></th>
                <th class="thead-val" width="50%"><b class="s15">资源值</b></th>
                <th class="thead-val" width="20%"><b class="s15">操作</b></th>
            </tr>
            </thead>
            ...
            <tr>
                <td align="center">
                    <div class="table-val">添加/修改员工信息</div>
                </td>
                <td align="center">
                    <div class="table-val">action访问</div>
                </td>
                <td align="center">
                    <div class="table-val">可访问</div>
                </td>
                <td align="center">
                    <div class="table-val">www.baidu.com</div>
                </td>
                <td align="center">
                    <div class="table-val">
                        <a class="btn btn-default btn-sm" href="javascript:void(0)">修改</a>
                        <a class="btn btn-danger btn-sm deleteThisResource" href="javascript:void(0)">删除</a>
                    </div>
                </td>
            </tr>
            </tbody>
            ...
            <tr>
                <th colspan="5" class="opacity0">111</th>
            </tr>
            </tfoot>
...
<script>
    ...
    window.onload = function () {
        ...
        // 点击删除商品分类
        $(".deleteThisResource").on("click", function () {
    ...
    $(function () {
        ...
        var table = $('#resource-table').dataTable(TableOptions);  // 用户表

        $("div.tableControl").html('' +
            '<a class="btn btn-default mr10" id="reloadTable" title="重新加载">刷新</a>' +
            '<a class="btn btn-info" id="addRole" title="新增角色" href="addResource.jsp">新增资源</a>'
        );
    });
