...
<div class="container-fluid animated fadeIn">
    <div class="col-xs-12">
        <div class="page-header">
            <h2>
                <i class="icon-table2 s24"></i>&nbsp;新建商品分类
            </h2>
        </div>
        <div class="emp-form">
            <form class="form-horizontal pt0" role="form">
                ...
                <div class="form-group">
                    <label for="productSelect" class="col-sm-2 control-label">商品分类</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label for="productTypeName" class="col-sm-2 control-label">分类名称</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" required placeholder="Class name" id="productTypeName">
                    </div>
                </div>
                <br>
                <div class="form-group">
