        ...
        <table cellpadding="0" cellspacing="0" class="table my-hover"
            ...
            <tr>
                <td align="center" width="25%">
                    <div class="table-val">1</div>
                </td>
                <td align="center" width="25%">
                    <div class="table-val">销售部</div>
                </td>
                <td align="center" width="25%">
                    <div class="table-val">010-88888-24134</div>
                </td>
                <td align="center" width="25%">
                    <div class="table-val">
                        <a class="btn btn-default btn-sm" href="findDeptById/">修改</a>
                        <a class="btn btn-danger btn-sm deleteThisDept" href="javascript:void(0)">删除</a>
                    </div>
                </td>
            </tr>
            </tbody>
...
<script>
    ...
    window.onload = function () {
        ...
        var _modalURL = "department/addDept.jsp";
    ...
    $(function () {
        ...
        $("div.tableControl").html('' +
            ...
            '<a class="btn btn-info" id="addDept" title="新增部门">新建部门</a>'
        );
    });
