...
<div class="container-fluid animated fadeIn">
    <div class="col-xs-12 my-content">
        <div class="page-header">
            <h1>
                <i class="icon-table2 s24" style="color: #9d9d9d;"></i>&nbsp;任务指派
            </h1>
        </div>
        <div class="table-container">
            ...
            <form action="#" method="post">
                <table cellpadding="0" cellspacing="0" class="table my-table table-bordered" id="order-table">
                    <thead>
                    <tr>
                        <th class="thead-val" width="33%"><b class="s15">商品类别</b></th>
                        <th class="thead-val" width="33%"><b class="s15">商品名称</b></th>
                        <th class="thead-val" width="33%"><b class="s15">数量</b></th>
                    </tr>
                    </thead>
                ...
                <div class="table-control clearfix p20">
                    <div class="form-inline text-center">
                        <select class="form-control input-lg per15 mr25">
                            <option value="-1">请选择</option>
                            <option value="1">张三</option>
                            <option value="2">李四</option>
                            <option value="3">王五</option>
                        </select>
                        <button class="btn btn-success btn-lg" type="submit">派 单</button>
                        <button class="btn btn-default btn-lg" type="button" onclick="window.history.back()">返 回</button>
                    </div>
                </div>
            </form>
        </div>
