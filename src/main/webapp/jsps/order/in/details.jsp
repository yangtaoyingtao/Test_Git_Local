...
<div class="container-fluid animated fadeIn">
    <div class="col-xs-12 my-content">
        <div class="page-header">
            <h2>
                <i class="icon-table2 s24" style="color: #9d9d9d;"></i>&nbsp;订单详情
            </h2>
        </div>
            ...
            <form action="#" method="post">
                ...
                <div class="table-control clearfix p25">
                    <div class="col-xs-12 text-center">
                        <button class="btn btn-success btn-lg" type="button" style="width: 180px" onclick="window.history.back()">返 回</button>
                    </div>
                </div>
            </form>
        </div>
